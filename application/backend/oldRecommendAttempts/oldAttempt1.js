/*
  This file was an attempt at using brain.js to predict recommendations based on user's ratings on genres. However,
  the runtime of this file is extremely slow and was extremely inefficient to test, let alone use as a solution for recommendations.
  This file has been abandoned and I have kept this here as a means to show my approaches for creating my recommendations.
  ...
  on books, with information about the books such as title and genre as a starting basis. Because the system was so slow, I implemented
  a caching system but this was pointless as the system was too slow to begin with and caching previous results would be useless if the 
  user was to get recommendations on a new set of books.

  brain.js documentation I referred to: https://github.com/BrainJS/brain.js#brainjs
*/
